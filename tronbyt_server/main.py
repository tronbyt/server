...
from tronbyt_server.dependencies import NotAuthenticatedException, auth_exception_handler, get_db
...
def handle_auth_exception(request: Request, exc: NotAuthenticatedException):
