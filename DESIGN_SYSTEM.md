...
### Success Colors (Success alerts only)

| Variable | Value | Usage |
|----------|-------|-------|
| `--green-50` | `#ecfdf5` / dark: `rgba(34, 197, 94, 0.1)` | Success background |
| `--green-500` | `#22c55e` | Success primary |
| `--green-600` | `#16a34a` | Success icons |
| `--green-800` | `#166534` / dark: `#86efac` | Success text |

### Danger Colors (Delete actions only)

| Variable | Value | Usage |
|----------|-------|-------|
| `--red-50` | `#fef2f2` / dark: `#450a0a` | Danger background |
| `--red-300` | `#fca5a5` | Danger borders |
| `--red-500` | `#ef4444` | Danger primary |
| `--red-600` | `#dc2626` | Danger hover |

> **Note:** Blue is NOT in the color palette. Info alerts use neutral + orange accent.
...
.badge.is-enabled {
    background: var(--neutral-900);  /* NOT green - see design system */
    color: var(--white);
}
```
...
- Use green except for `.alert-success`
- Use blue at all (removed from palette)
