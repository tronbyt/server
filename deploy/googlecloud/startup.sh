...
SERVER_HOSTNAME=$(curl "http://metadata.google.internal/computeMetadata/v1/instance/network-interfaces/0/access-configs/0/external-ip" -H "Metadata-Flavor: Google")
...
cat <<EOF > .env
SERVER_HOSTNAME_OR_IP=${SERVER_HOSTNAME}
